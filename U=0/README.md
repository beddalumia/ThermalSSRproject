...
The files `Thermal1D_PPTfull_d%d_f%g.csv`, `Thermal1D_PPTpSSR_d%d_f%g.csv` and
...
Similarly, `Thermal1D_REEpSSR_d%d_f%g.csv` and
`Thermal1D_REEnSSR_d%d_f%g.csv` store the
